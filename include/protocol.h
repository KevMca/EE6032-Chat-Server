...
// Protocol header file with message classes for standardising how messages are sent between
...
class BaseMSG  {
 public:
    ...
    // Returns -> the data that contains information about a std::string
